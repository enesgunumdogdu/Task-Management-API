package com.enesgunumdogdu.tasks.domain.entities;
...
public class Task {
    ...
    public Task(UUID id, LocalDateTime created, String title, String description, LocalDateTime dueDate, TaskStatus status, TaskPriority priority, LocalDateTime updated) {
